...
You can use `wait-what` at any point, in any conversation, inside any other skill. It repairs one message after the fact. The real cure is a shared language agreed upfront, and that is [grill-with-docs](../engineering/grill-with-docs.md): a grilling session that runs [domain-modeling](../engineering/domain-modeling.md) as it goes, so the words you both use land in your `CONTEXT.md`. If you're unsure which skill fits the moment, [guide](../engineering/guide.md) routes you.
